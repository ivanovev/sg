...
from .callbacks import strip0x_fmt_cb, mdio_cmd_cb
...
R02|0|PHY ID Number|0|Assigned to the 3rd through 18th bits of the;Organizationally Unique Identifier (OUI), respectively.;OUI=00800Fh
R03|10|PHY ID Number|0|
R03|4|Model Number|0|
R03|0|Revision Number|0|
R04|15|Next Page|0|
R04|14|Reserved|0|
...
R17|7|Reserved|0|Write as 0, ignore on read.
...
R17|4|Reserved|0|Write as 0, ignore on read.
...
R17|1|ENERGYON|0|
R17|0|Reserved|0|This bit should be set only during lab testing
R18|15|Reserved|0|Write as 0, ignore on read.
...
R18|8|Reserved|0|Write as 0, ignore on read.
...
R27|14|Reserved|0|Reserved
R27|13|CH_SELECT|0|Manual Channel Select;0 - MDI -TX transmits RX receives;1 - MDIX -TX receives RX transmits
R27|12|Reserved|0|Write as 0. Ignore on read.
R27|5|Reserved|0|Write as 0. Ignore on read.
R27|4|XPOL|0|Polarity state of the 10Base-T:;0 - Normal polarity;1 - Reversed polarity
R27|0|Reserved|0|Reserved
R28|0|Reserved|0|Do not write to this register. Ignore on read.
R29|8|Reserved|0|
...
R29|1|INT1|0|
R29|0|Reserved|0|
R30|8|Reserved|0|Write as 0; ignore on read.
R30|1|Mask Bits|0|1 = interrupt source is enabled;0 = interrupt source is masked
R30|0|Reserved|0|Write as 0; ignore on read
R31|13|Reserved|0|Write as 0, ignore on read.
...
R31|10|Reserved|0|Write as 0, ignore on Read.
...
R31|5|Reserved|0|Write as 0, ignore on Read.
...
R31|1|Reserved|0|Write as 0; ignore on Read
